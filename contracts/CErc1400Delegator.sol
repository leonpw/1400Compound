...
/**
 * @title Compound's CErc1400Delegator Contract
 * @notice CTokens which wrap an EIP-1400 underlying and delegate to an implementation
 * @author Compound
 */
contract CErc1400Delegator is CTokenInterface, CErc1400Interface, CDelegatorInterface {
    /**
    ...
    fallback() external payable {
        require(msg.value == 0,"CErc1400Delegator:fallback: cannot send value to fallback");
